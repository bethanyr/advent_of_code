...
class CircuitPanel {
    constructor() {
        ...
        this.currentWire1Position = {x: 10000, y: 10000};
        this.currentWire2Position = {x: 10000, y: 10000};
        this.centralPort = {x: 10000, y: 10000};
        this.totalSteps = 0;
    ...
    move(move, position, positions) {
        ...
        if (position.x < 0 || position.y < 0) {
            console.log('negative position', position);
        }
        return position;
    }
...
function main(array) {
    ...
    panel.wire1Positions[10000] = new Array();
    panel.wire1Positions[10000][10000] = 0;

    panel.wire2Positions[10000] = new Array();
    panel.wire2Positions[10000][10000] = 0;
